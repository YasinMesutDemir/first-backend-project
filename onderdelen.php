...
<div style="padding: 30px; color: white; font-family: Orbitron, sans-serif;">
<?php
if (in_array($selected, $toegestaan)) {
    ...
    if (count($rows) > 0) {
        echo "<table style=\"background-image: url('foto/background-onderdelen.png'); background-size: cover; background-position: center;\" class='onderdelen' border='1' cellpadding='10' cellspacing='0'>";
        echo "<tr>";
        ...
        foreach ($rows as $row) {
            ...
            foreach ($row as $key => $value) {
                ...
                if ($key === 'image_url') {  
                    echo "<td><img src=\"" . htmlspecialchars($value) . "\" alt=\"image\" style=\"height:55px;\"></td>";
                } else {
    ...
    echo "<p style='color:red;'>Ongeldige selectie.</p>";
} else {
    echo "<p>Kies een categorie om onderdelen te bekijken.</p>";
}
?>
</div>
