...
<div class="container">
  ...
  <tr>
    ...
    <td style="padding-left: 36%; white-space: nowrap;"><h1 style="margin: 0; color: white;"></h1></td>
...
<form class="form" method="POST">
      ...
      <p class="signup-link">Heeft u al een account? <a href="registreer.php">Login</a></p>
   </form>
